let logger = require('omelo-logger').getLogger('omelo-admin', 'ConsoleService');
let MonitorAgent = require('./monitor/monitorAgent');
let EventEmitter = require('events').EventEmitter;
let MasterAgent = require('./master/masterAgent');
let schedule = require('omelo-scheduler');
 ...
 * @api public
 */
let ConsoleService = function(opts) {
